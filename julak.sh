...
# Repository Github
jamban="https://raw.githubusercontent.com/hsspunya93/JVN/main/"
...
WantedBy=multi-user.target
EOF
#wget ${julak}cc/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
clear
cd
...
insdns() {
#wget ${jamban}service/main/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}
